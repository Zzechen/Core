...
public class PhoneUtils {
    ...
    public static String getPhoneStatus(Context context) {
        ...
        str.append("Line1Number = " + tm.getLine1Number() + "\n");
        str.append("NetworkCountryIso = " + tm.getNetworkCountryIso() + "\n");
        str.append("NetworkOperator = " + tm.getNetworkOperator() + "\n");
        str.append("NetworkOperatorName = " + tm.getNetworkOperatorName() + "\n");
        str.append("NetworkType = " + tm.getNetworkType() + "\n");
        str.append("honeType = " + tm.getPhoneType() + "\n");
        str.append("SimCountryIso = " + tm.getSimCountryIso() + "\n");
        str.append("SimOperator = " + tm.getSimOperator() + "\n");
        str.append("SimOperatorName = " + tm.getSimOperatorName() + "\n");
        str.append("SimSerialNumber = " + tm.getSimSerialNumber() + "\n");
        str.append("SimState = " + tm.getSimState() + "\n");
        str.append("SubscriberId(IMSI) = " + tm.getSubscriberId() + "\n");
        str.append("VoiceMailNumber = " + tm.getVoiceMailNumber() + "\n");
        return str.toString();
    }
